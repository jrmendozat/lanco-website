...
function assing(item_name) {
  performLfmRequest('assingfile', {items: item_name})
    .done(refreshFoldersAndItems);
}

function doassing(item_name) {
  performLfmRequest('doassingfile', {items: item_name})
      .done(refreshFoldersAndItems);
}


$(".btn-doassing").on('click', function(e){
  e.preventDefault();
      
      console.log('hola');

      var href = $(this).data('href');
      var nameassing = $(this).data('id');
      var id = $("#id_product").val();
      
      //window.location.href = href;
      window.location.href = href + "/" + id + "/" + nameassing;
  });  
