...
<div class="container text-center">
	<div class="page-header">
		<h1>
			...
			Clasificación por {{$config_quoteandsell->name_category_2}} <small>[Editar clasificación]</small>
		</h1>
	</div>
    ...
    <div class="page-medium">
        ...
        <form method="post" action="{{action('Admin\CategorytwoController@update', $id)}}">
            @csrf
