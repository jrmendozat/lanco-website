  ...
  <div class="container-fluid" id="wrapper">
    <div class="panel panel-primary hidden-xs">
      <div class="panel-heading">
        ...
        <a href="{{ route('dashboard.index') }}" type="button" style="margin-bottom:5px;  border-radius:1em;"class="btn-warning btn-sm"><i style="margin-right:5px" class="fas fa-tachometer-alt"></i>Regresar</a>
      </div>
    </div>
    <div class="row">
