	...
	<div class="container text-center">
		<div class="page-header">
			<h1>
				...
				Clasificación por {{$config_quoteandsell->name_category_1}} <a href="{{ route('category.create') }}" class="btn btn-warning"><i class="fa fa-plus-circle"></i> Clasificación</a>
			</h1>
		</div>
		<div class="page">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tbody>
						@foreach($categories as $category)
							<tr>
							  	<td>
							  		<a href="{{action('Admin\CategoryController@edit', $category['id'])}}" class="btn btn-primary"><i class="far fa-edit"></a></td>
								</td>
                              	<td>
