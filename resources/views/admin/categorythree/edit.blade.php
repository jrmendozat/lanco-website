...
<div class="container text-center">
	<div class="page-header">
		<h1>
			...
			Clasificación por {{$config_quoteandsell->name_category_3}} <small>[Editar clasificación]</small>
		</h1>
	</div>
    <div class="page-medium">
        ...
        <form method="post" action="{{action('Admin\CategorythreeController@update', $id)}}">
            @csrf
            ...
            <div class="form-group">
                ...
                <a href="{{ route('categorythree.index') }}" class="btn btn-warning">Cancelar</a>
            </div>
        </form>    
    </div>
</div>
