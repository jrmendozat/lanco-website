...
<div style="margin-top:30px" class="show-products-detailmob response">
  ...
  <div style="margin-top:10px" class="block90 text-center">
    <img class="img-fluid" src="{{URL::asset($product->image)}}" width="80%" class="stylishglass" alt="Card image">
  </div>
  <div style="margin-top:10px" class="block80 text-center">
   	<h4 style="font-family: 'Open Sans', sans-serif; font-weight: 400; margin-top:15px">{{$product->name}}</h4>
		<h3 style="font-family: 'Open Sans', sans-serif; font-weight: 700; margin-top:10px">{{$product->sku}}</h3>
		<h4 style="font-family: 'Open Sans', sans-serif; font-weight: 400; margin-top:10px">{{$product->extract}}</h4>
		<h5 style="font-family: 'Open Sans', sans-serif; font-weight: 400; margin-top:15px">{{$product->description}}</h5>
  </div>
  <div style="margin-top:10px" class="block90 text-center">
  ...
  <hr>
  <div style="margin-top:10px" class="block90 text-center">
    <a href="{{ route('download-file',$product->download_1)}}"><img  class="img-fluid" src="/image/botones/ICON-05.png" width=30% alt="Icon-5"></a>
  </div>
